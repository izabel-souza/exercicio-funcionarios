CREATE DATABASE EXERCICIO_FUNCIONARIOS;
USE EXERCICIO_FUNCIONARIOS;
...
--EXERCICIO 1
/* teste para melhorar perfomance */
SELECT COUNT(*), departamento 
from funcionarios 
GROUP BY departamento; --42 = filmes e 106 = roupas
...
SELECT COUNT(*), sexo
from funcionarios
GROUP BY sexo; --feminino = 491

SELECT COUNT(*), departamento
from funcionarios
GROUP BY departamento; --filmes = 42 e lar = 104


/* 2 - Traga o email de funcionárias que trabalhem no departamento de filmes OU no departamento lar.  */
...
SELECT COUNT(*), sexo
from funcionarios
GROUP BY sexo; --masculino = 484

SELECT COUNT(*), departamento
from funcionarios
GROUP BY departamento; --jardim = 94

/* 3 - Traga os funcionários do sexo masculino OU os funcionários que trabalhem no setor jardim */
SELECT * FROM funcionarios 
